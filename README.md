...
](https://minecraftvr.ci.cloudbees.com/job/minecrift-1.5.2/)
...
Download and run the latest minecrift-1.5.2-b###-installer.exe/jar.
...
Use the MCP environment in /mcp to modify, test, and recompile.  If you use
